...
<HTML>
   ...
   <body MS_POSITIONING="GridLayout">
      <form id="Form1" method="post" runat="server">
         ...
         <asp:Label id="LblUser" style="Z-INDEX: 109; LEFT: 176px; POSITION: absolute; TOP: 152px" runat="server"
         ...
         <asp:Label id="LblPwd" style="Z-INDEX: 102; LEFT: 176px; POSITION: absolute; TOP: 192px" runat="server"
            Width="104px" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" meta:resourcekey="LblPwdResource1">Password:</asp:Label>
         ...
         <asp:TextBox id="TxtUser" style="Z-INDEX: 104; LEFT: 296px; POSITION: absolute; TOP: 144px" runat="server"
            tabIndex="1" Width="160px" meta:resourcekey="TxtUserResource1"></asp:TextBox>
         <asp:Label id="lblMessage" style="Z-INDEX: 107; LEFT: 168px; POSITION: absolute; TOP: 280px"
